This is a .Net Core Web API project to retrieve weather details of different cities based on user inputs and IP address. The API has following endpoints:
